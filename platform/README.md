...
| `db/migrations/0048_kruistabel.sql` | De analysekaart: persona × angle × bewustzijnsniveau × product, gewogen naar spend, met eerlijke lege vakken |
