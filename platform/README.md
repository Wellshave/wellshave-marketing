...
| `db/test/import-tracker.sh` | Testlus voor 0035 t/m 0038 — 71 controles; de kern is dat een breakdown optelt tot het aantal rijen, dat een nieuwe creative niet langs de eis uit 0030 glipt, en dat een vastgezet cijfer wint van de meting |
